...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `avatar` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'foto-usuario.png',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,3,'asd','asd','0000-00-00 00:00:00','asd','asd','0000-00-00 00:00:00',NULL,'foto-usuario.png'),(2,3,'asd','asd1',NULL,'asd','asd','0000-00-00 00:00:00',NULL,'foto-usuario.png'),(3,3,'asd','asd2',NULL,'asd','asd',NULL,NULL,'foto-usuario.png'),(4,3,'asd','asd3',NULL,'asd','asd',NULL,NULL,'foto-usuario.png'),(5,3,'asd','asd4',NULL,'asd','asd',NULL,NULL,'foto-usuario.png'),(6,3,'asd','asd5',NULL,'asd','asd',NULL,NULL,'foto-usuario.png'),(7,3,'asd','asd6',NULL,'asd','asd',NULL,NULL,'foto-usuario.png'),(8,3,'asd','asd7',NULL,'asd','asd',NULL,NULL,'foto-usuario.png'),(9,3,'asd','asd8',NULL,'asd','asd',NULL,NULL,'foto-usuario.png'),(10,1,'atila','atilaelrey@live.com.ar',NULL,'$2y$10$JrVhn3ZZ3kVecCtIgk/2/OttU8uTuHZdE1.97XE6tzUyfLdVScBEq','58A680YdYxWxkYU5RooFggOiUz08kWj13ukN5tmR1TRPwnZre2wflECPgQ4r','2020-02-21 01:47:19','2020-02-21 01:47:19','foto-usuario.png'),(11,2,'Atila2','atilaelrey2@live.com.ar',NULL,'$2y$10$H3aDQGaxbK04Q1axhcXQ1epp0YAlgBaDHRRaRuLe50GMfdHkXdZju',NULL,'2020-02-27 17:10:13','2020-02-28 21:40:23','wI4haUReoFs8TfpgzAcnsThHgogb4wXpDYbmN9vk.jpeg'),(12,2,'lucho','lucho@test.com',NULL,'$2y$10$JnJKZzLGXWQA5G4n00TzEeeP9dp2tKmKyocSVTTndfRk0DVvhZjSq',NULL,'2020-02-28 01:04:11','2020-02-28 01:04:11','foto-usuario.png');
...
-- Dump completed on 2020-02-28 16:22:17
