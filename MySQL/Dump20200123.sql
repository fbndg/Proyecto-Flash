...
CREATE TABLE `productos` (
  ...
  `imagenO` varchar(50) DEFAULT NULL,
  `imagenP` varchar(50) DEFAULT NULL,
  `nombreModelo` varchar(100) DEFAULT NULL,
  `modeloNumber` varchar(100) DEFAULT NULL,
...
INSERT INTO `productos` VALUES (1,1,1,14839.00,13490.00,10,1,'dk1bcopia.png','dk1.png',NULL,NULL),(2,2,1,13995.00,13490.00,15,2,'dk2copia.png','dk2.png',NULL,NULL),(3,1,1,14990.00,0.00,10,3,'dk3copia.png','dk3.png',NULL,NULL),(4,2,1,15495.00,0.00,20,4,'dk4copia.png','dk4.png',NULL,NULL),(5,1,1,15990.00,0.00,25,5,'dk5copia.png','dk5.png',NULL,NULL),(6,3,1,16495.00,0.00,15,6,'dk6copia.png','dk6.png',NULL,NULL),(7,4,2,30990.00,0.00,10,7,'noteb1copia.png','noteb1.png',NULL,NULL),(8,5,2,14990.00,0.00,15,8,'noteb2copia.png','noteb2.png',NULL,NULL),(9,6,2,14990.00,0.00,10,9,'noteb3copia.png','noteb3.png',NULL,NULL),(10,7,2,19799.00,17999.00,20,10,'noteb4copia.png','noteb4.png',NULL,NULL),(11,7,2,19490.00,0.00,25,11,'noteb5copia.png','noteb5.png',NULL,NULL),(12,8,2,22549.00,0.00,15,12,'noteb6copia.png','noteb6.png',NULL,NULL),(13,9,3,7170.00,0.00,10,13,'imp1copia.png','imp1.png',NULL,NULL),(14,8,4,8749.00,0.00,10,14,'imp2copia.png','imp2.png',NULL,NULL),(15,10,3,12999.00,0.00,10,15,'imp3copia.png','imp3.png',NULL,NULL),(16,9,3,12189.00,0.00,20,16,'imp4copia.png','imp4.png',NULL,NULL),(17,8,4,14499.00,0.00,25,17,'imp5copia.png','imp5.png',NULL,NULL),(18,9,3,15449.00,0.00,15,18,'imp6copia.png','imp6.png',NULL,NULL),(95,1,1,70000.00,65000.00,15,NULL,'TUF2FX505DV2.','TUF2FX505DV2.','TUF2','FX505DV2');
...
-- Dump completed on 2020-01-23 19:18:35
