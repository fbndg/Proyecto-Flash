      ...
      <div class="row cont2">
        <div class="col-12 mx-auto entero2">
          <div class="card card-signin flex-row my-5">
            <div class="card-body">
              <form class="form-signin" method="POST" action="controladores/upload.php" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="form-label-group col">
                  <input type="text" id="nombreModelo" name="nombreModelo" class="form-control" placeholder="Nombre Modelo"  autofocus value="">
                ...
                <div class="form-label-group col">
                  <input type="text" id="numberModelo" name="numberModelo" class="form-control" placeholder="numberModelo" required autofocus value="">
              ...
              <div class="form-row">
                <div class="form-label-group col">
                  <input type="text" id="stock" name="stock" class="form-control" placeholder="Stock" required value="<?= persistirDato("email", $erroresEnRegistro) ?>">
                  <label class="ml-1" for="stock">Stock</label>
                  <?php if(isset($erroresEnRegistro['email'])) {
                ...
                <div class="form-label-group col">
                  <input type="precio" id="precio" name="precio" class="form-control" placeholder="Precio" required value="<?= persistirDato("email", $erroresEnRegistro) ?>">
                ...
                <div class="form-label-group col">
                  <input type="oferta" id="oferta" name="oferta" class="form-control" placeholder="Oferta" required value="<?= persistirDato("email", $erroresEnRegistro) ?>">
                  ...
                  <?php
                    ...
                    while ($categorias !=null) { ?>
                      <div class="custom-control custom-checkbox col mr-sm-2">
                        <input type="checkbox" name="cat" value="<?=$categorias["idcategoria"]?>" class="custom-control-input" id="cat<?=$categorias["idcategoria"]?>">
              ...
              <div class="form-group">
                ...
                <select multiple class="form-control" name="marca" id="marca">
                  <?php
                    ...
                    while ($marcas !=null) { ?>
                      <a href='producto.php?id='><img src='img/'></a>
                      <option class="pl-2" value="<?=$marcas["idMarca"]?>"><?=$marcas["marca"]?></option>
