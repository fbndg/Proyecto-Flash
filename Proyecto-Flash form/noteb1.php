     ...
     <section class="main">
       <section class="articles">
         <div class="flex-container indeximg">
           <article>
             <h2><?=$producto["nombreModelo"]." ".$producto["modeloNumber"]?></h2>

             <div class="d-flex flex-row bd-highlight mb-3"><!--04/01: Agregué este div para encolumnar la img-->
               <div class="p-2 bd-highlight">
                 <a href="canasta.php" class="nav-link"><img style="width:308px" src="img/<?=$producto["imagenP"]?> " alt="Dell Inspiron 3481 i3"></a>
               ...
               <div class="d-flex p-2 bd-highlight"><!--04/01: Agregué estos divs para encolumnar el p-->
                ...
                <a class="btn btn-primary" href="editar.php?id=<?=$producto["idProducto"]?>">edit</a>
              </article>
            </div>
          </section>
        </section>
